...
//     document.getElementById('resultCalories').style.display = 'none';
...
//     document.getElementById('resultCalories').style.display = 'block';
//     document.getElementById('resultCalories').innerHTML += `<p>That is the amount of calories you need per day to maintain your weight.</p>`
